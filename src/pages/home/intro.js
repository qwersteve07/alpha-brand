...
const Block1 = () => {
  ...
  return (
    <div className={styles.block1}>
      <Scene triggerElement="#svg-block" triggerHook={0.9} duration={700} reverse={true}>
        {progress => (
          <Tween
            from={{
              opacity: 0,
      ...
      <Scene triggerElement="#svg-line1" triggerHook={0.9} duration={700} reverse={true}>
        {progress => (
          <Tween
            from={{
              opacity: 0,
          ...
          >
            <svg id="svg-line1" viewBox="0 0 895.5 488.1" className={styles['svg-line1']}>
              <Scene triggerElement="#line1-poly1" triggerHook={0.9} duration={700} reverse={true}>
                {progress => (
                  <Tween
                    from={{
                      strokeDasharray: 723,
              ...
              <Scene triggerElement="#line1-poly2" triggerHook={0.9} duration={700} reverse={true}>
                {progress => (
                  <Tween
                    from={{
        ...
        {progress => (
          ...
          >
            <svg id="svg-line2" viewBox="0 0 904.241 497.748" className={styles['svg-line2']}>
              <Scene triggerElement="#line2-rect" triggerHook={0.9} duration={600} reverse={true}>
                {progress => (
                  <Tween
                    from={{
      ...
      <Scene offset={400} triggerHook={0.9} duration={700} reverse={true}>
        {progress => (
          <Tween
            from={{
              opacity: 0,
      ...
      <Scene offset={400} triggerHook={0.8} duration={500} reverse={true}>
        {progress => (
          <Tween
            from={{
              opacity: 0,
      ...
      <Scene offset={600} triggerHook={0.8} duration={500} reverse={true}>
        {progress => (
          <Tween
            from={{
              opacity: 0,
...
const Block2 = () => {
          ...
          {splitImageData.map(item => {
            return (
              <Scene triggerHook="0.8" duration={800} triggerElement={`#${item.id}`} key={item.id}>
                {progress => (
                  <Tween to={{ ...item.to, opacity: 0.7 }} totalProgress={progress} paused>
  ...
  return (
    <div className={styles.block2}>
      <Scene triggerElement="#intro-content" triggerHook={0.8} duration={700} reverse={true}>
        {progress => (
          <Tween
            from={{
              opacity: 0,
